...
import '../../../../bloc/jokes/jokes_bloc.dart';
import '../../../../data/models/joke.dart';
import '../../../../widgets/card_button.dart';
import 'joke_card_image.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
            JokeCardImage(
              bgColor: cardColor,
              image: const Image(
                image: AssetImage('./assets/images/dadjokes.png'),
              ),
            ),
            Expanded(
              child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          CardButton(
                            ...
                            icon: Icons.copy,
                            onPressed: () => context.read<JokesBloc>().add(
                                  JokeCopyEvent(widget.joke.joke),
                                ),
                          ),
                        ],
                      ),
